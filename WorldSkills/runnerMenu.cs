...
namespace WorldSkills
{
    public partial class runnerMenu : Form
    {
        ...
        private void headerBlock_Click(object sender, EventArgs e)
        {

        }

        private void remainTime_Paint(object sender, PaintEventArgs e)
        {

        }

        private void footerBlock_Click(object sender, EventArgs e)
        {
