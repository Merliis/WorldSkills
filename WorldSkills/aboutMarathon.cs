...
namespace WorldSkills
{
    public partial class aboutMarathon : Form
    {
        ...
        private void bancoBanespa_Click(object sender, EventArgs e)
        {
            picZoomBox.Visible = true;
            picZoomBox.Image = global::WorldSkills.Properties.Resources.banco_banespa;
        }

        private void parkLake_Click(object sender, EventArgs e)
        {
            picZoomBox.Visible = true;
            picZoomBox.Image = global::WorldSkills.Properties.Resources.ibirapuera_park_lake;
        }

        private void marathonImg_Click(object sender, EventArgs e)
        {
            picZoomBox.Visible = true;
            picZoomBox.Image = global::WorldSkills.Properties.Resources.marathon_image;
        }

        private void teatroMunicipal_Click(object sender, EventArgs e)
        {
            picZoomBox.Visible = true;
            picZoomBox.Image = global::WorldSkills.Properties.Resources.teatro_municipal;
        }

        private void picZoomBox_Click(object sender, EventArgs e)
        {
